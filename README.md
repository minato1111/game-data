...
### ユーザビリティ（最新追加機能）
- ✅ **テーブルヘッダークリックソート** - 日付、ID、名前、Power等をクリックして昇順/降順切り替え
- ✅ **名前クリックで個人分析** - プレイヤー名をクリックすると自動的に個人分析タブに遷移
- ✅ **クイックフィルターボタン** - 最新データ、直近7日、30日、全期間をワンクリックで切り替え
- ✅ **タイトルクリックでTOP** - ヘッダーのタイトルをクリックするとデータ一覧タブに戻る
